...
class PlayerState:
    ...
    def is_art_requirement_met(self, card, art):
        ...
        # Calculate cost reductions from reduce_art_cost effects
...
class GameEngine:
    ...
    def do_effect(self, effect_player : PlayerState, effect):
        ...
        match effect["effect_type"]:
            ...
            case EffectType.EffectType_AttachCardToHolomem_Internal:
                ...
                if attached_card and "attached_effects" in attached_card:
                    ...
                    if on_attach_effects:
                        ...
                        self.add_effects_to_front(on_attach_effects)
            ...
            case EffectType.EffectType_BloomFromSpecial:
            ...
            case EffectType.EffectType_PowerBoostPerAllMascots:
                ...
                self.handle_power_boost(total, effect["source_card_id"])
            case EffectType.EffectType_PowerBoostPerAttachmentNameOnStage:
                per_amount = effect["amount"]
                attachment_name = effect["attachment_name"]
                performer_only = effect.get("performer_only", False)
                if performer_only:
                    holomems = [self.performance_performer_card]
                else:
                    holomems = effect_player.get_holomem_on_stage()
                count = 0
                for holomem in holomems:
            ...
            case EffectType.EffectType_PowerBoostPerArchivedHolomem:
                ...
                self.handle_power_boost(total, effect["source_card_id"])
            case EffectType.EffectType_PowerBoostPerCheerOnBothStages:
                per_amount = effect["amount"]
            ...
            case EffectType.EffectType_ChooseStackedToHand:
                ...
                if self.down_holomem_state and self.down_holomem_state.holomem_card:
                    ...
                    if len(cards_to_choose_from) > 0:
                        ...
                        self.set_decision({
                            ...
                            "remaining_cards_action": "nothing",
                            "source_card_id": effect["source_card_id"],
                            "effect_resolution": self.handle_choose_stacked_to_hand_result,
                            "continuation": self.continue_resolving_effects,
                        })
                        passed_on_continuation = True
            ...
            case EffectType.EffectType_BloomFromStacked:
            ...
            case EffectType.EffectType_ActivateHolomem:
                ...
                if len(resting_holomem_ids) == 0:
                    ...
                    self.set_decision({
                        ...
                        "amount_min": 1,
                        "amount_max": 1,
                        "effect_resolution": self.handle_activate_holomem,
                        "continuation": self.continue_resolving_effects,
                    })
                    passed_on_continuation = True
            case EffectType.EffectType_TakeExtraTurn:

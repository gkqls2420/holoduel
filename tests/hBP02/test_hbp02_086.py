...
class Test_hBP02_086(unittest.TestCase):
  ...
  def test_hbp02_086_one_tool_only(self):
    ...
    validate_consecutive_events(self, self.player1, events, [
      ...
      (EventType.EventType_MoveCard, { "from": "floating", "to_zone": "holomem", "zone_card_id": chosen_card_id, "card_id": tool_card_id }),
      (EventType.EventType_Decision_MainStep, {})
    ])

    self.assertCountEqual(ids_from_cards(center_card["attached_support"]), [attached_card_id])
    self.assertCountEqual(ids_from_cards(chosen_card["attached_support"]), [tool_card_id])

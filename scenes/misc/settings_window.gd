...
@onready var use_web_server : CheckButton = $PanelContainer/MarginContainer/VBoxContainer/UseWebServer
...
func load_settings():
	...
	var big_card_pressed = GlobalSettings.get_user_setting(GlobalSettings.ShowBigCard)
	show_card_info.set_pressed_no_signal(overlay_pressed or panel_pressed or big_card_pressed)
...
func change_card_info_setting(value, setting_name):
	...
	if setting_name == "ShowCardInfo":
		...
		$PanelContainer/MarginContainer/VBoxContainer/MarginContainer/VBoxContainer/ShowBigCard.button_pressed = value
	else:
		var overlay_pressed = show_overlay_info.button_pressed
		var panel_pressed = show_panel_info.button_pressed
		var big_card_pressed = $PanelContainer/MarginContainer/VBoxContainer/MarginContainer/VBoxContainer/ShowBigCard.button_pressed
		show_card_info.set_pressed_no_signal(overlay_pressed or panel_pressed or big_card_pressed)
